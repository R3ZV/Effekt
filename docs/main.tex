...
This paper presents different types of audio filters, the math and physics behind their implementation, possible variations and their effect on diverse audio samples using different parameters. 

\section{Samples used}

\begin{itemize}
    \item \href{https://www.youtube.com/watch?v=Gd9OhYroLN0}{Crawling, Linkin Park} (20s--34s).
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{Effekt/samples/crawling_scream_spect_ch_0.png}
        \caption{Spectogram for crawling}
        \label{fig:init_crawling_scream_spect_ch_0}
    \end{figure}
    
    \item Electronic guitar interpretation of \href{https://www.youtube.com/watch?v=0J2QdDbelmY}{Seven Nation Army}(first 10s)
    
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{Effekt/samples/raw-7army.png}
        \caption{Spectogram for raw electronic guitar Seven Nation Army}
        \label{fig:init_7army_scream_spect_ch_0}
    \end{figure}
    
    \item Calm Guitar downloaded from the internet.

     \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{Effekt/samples/calm_guitar_spect_ch_0.png}
        \caption{Spectogram for calm guitar}
        \label{fig:init_calm_guitar_spect_ch_0}
    \end{figure}
...
Below are the spectrograms for the outputs of the SVF filter applied to the crawling sample from Figure \ref{fig:init_crawling_scream_spect_ch_0} 
...
Below are the spectrograms for the outputs of the binaural rotation filter applied to the crawling sample from Figure \ref{fig:init_crawling_scream_spect_ch_0} 
...
For all results the following parameters were kept constant:
...
Below are the spectrograms for the outputs of the crybaby effect applied to the raw electronic guitar interpretation of Seven Nation Army, Figure \ref{fig:init_7army_scream_spect_ch_0} 
...
Here is the spectogram for the one that sounded "the best" on crawling (spectogram for initial sample: Figure \ref{fig:init_crawling_scream_spect_ch_0}):

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Effekt/Bitcrusher/crawling_scream_ch0.png}
    \caption{Bitcrusher on crawling, downsampling=8 samples, bit count=8}
    \label{fig:bitcrusher_crawling_scream_ch0}
\end{figure}

But I think this effect was better suited for the calm guitar sample (spectogram for initial sample: Figure \ref{fig:init_calm_guitar_spect_ch_0}):

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Effekt/Bitcrusher/calm_guitar_ch_0.png}
    \caption{Bitcrusher on calm guitar, downsampling=8 samples, bit count=8}
    \label{fig:bitcrusher_crawling_scream_ch0}
\end{figure}
...
Here is the resulted spectogram after applying the filter on crawling (spectogram for initial sample: Figure \ref{fig:init_crawling_scream_spect_ch_0})

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Effekt/cabinet/crawling_scream_spect.png}
    \caption{Cabinet applied on crawling}
    \label{fig:cabinet_crawling_scream_spect}
\end{figure}
...
Here is the resulted spectogram after applying the filter on the calm guitar sample (spectogram for initial sample: Figure \ref{fig:init_calm_guitar_spect_ch_0})

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Effekt/overdrive/calm_guitar_spect.png}
    \caption{Overdrive applied on calm guitar}
    \label{fig:overdrive_calm_guitar}
\end{figure}
...
Here is the resulted spectogram after applying the filter on the crawling sample (spectogram for initial sample: Figure \ref{fig:init_crawling_scream_spect_ch_0})

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Effekt/pitch_shifter/crawling_low_pitch_spect.png}
    \caption{Pitch-shifter low pitch applied on crawling}
    \label{fig:low_pitch_shifter_crawling}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Effekt/pitch_shifter/crawling_high_pitch_spect.png}
    \caption{Pitch-shifter high pitch applied on crawling}
    \label{fig:high_pitch_shifter_crawling}
\end{figure}

\section{References}

\begin{itemize}
    \item \url{https://people.montefiore.uliege.be/josmalskyj/files/Gardner1995Efficient.pdf}
    \item \url{https://redwirez.com/pages/the-marshall-1960a-ir-pack}
    \item \url{https://www.native-instruments.com/fileadmin/ni_media/downloads/pdf/VAFilterDesign_2.1.0.pdf}
    \item Spatial Audio by Francis Rumsey
    \item \url{https://ccrma.stanford.edu/~dtyeh/papers/yeh10_taslp.pdf}
    \item \url{https://www.musicdsp.org/en/latest/Analysis/97-envelope-detector.html}
    \item \url{https://www.uncini.com/dida/tsa/mod_tsa/Chap_08.pdf}
    \item \url{https://www.melaudia.net/zdoc/sweepSine.PDF}
    \item \url{https://re.public.polimi.it/bitstream/11311/1203185/1/WD_NR_TASLP_Bernardini_etal_2021_RG.pdf}
    \item DAFX: Digital Audio Effects, 2nd Edition Udo Zölzer
\end{itemize}
\end{document}